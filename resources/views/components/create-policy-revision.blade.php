...
<form method="POST" action="{{ route('savePolicyRevision') }}">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-bordered">
            <tr class="odd gradeX">
                ...
                <td>
                    <b>Date: </b> <input type="text"  name="comp_date" class="datepicker" autocomplete="off" required style="width:35%" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" />
                </td>
            </tr>
        </table>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover">
            <tr class="odd gradeX">
                <td>
                    <b>Revision Date: </b> <input type="text"  name="revision_date" class="datepicker" autocomplete="off" required style="width:35%" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" />
                </td>
                <td>
