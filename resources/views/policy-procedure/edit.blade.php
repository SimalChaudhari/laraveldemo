    ...
    <div class="col-sm-12 col-xs-12">
		...
		<div class="panel panel-default panel-custom">
			<div class="panel-heading">
				<div class="row">
					<div class="col-sm-12 col-xs-12" style="position: relative;">
						<h3 class="panel-title"><i class="fa fa-2x fa-envelope-open" aria-hidden="true"></i> Edit Policy: {{ $policy->policy_name }}</h3>
			...
			<div class="panel-body">
				...
				<form class="validateForm" action="{{ route('policy-procedure.update', $policy->uuid) }}" method="POST" enctype="multipart/form-data" role="form">

					@csrf

					<div class="form-group">
						<label for="name">Policy Name{!! $required_field_html !!}</label>
						<input type="text" class="form-control validate[required, maxSize[255]]" name="policy_name" value="{{ $policy->policy_name }}" />
					...
					<div class="form-group">
						...
						<textarea class="summernote" name="content">{{ $policy->content }}</textarea>
					...
					<input type="submit" name="submit" class="btn btn-custom-primary" value="Update Policy" />
