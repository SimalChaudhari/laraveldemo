    ...
    <div class="col-sm-12 col-xs-12">
		...
		<div class="panel panel-default panel-custom">
			<div class="panel-heading">
				<div class="row">
					<div class="col-sm-12 col-xs-12" style="position: relative;">
						<h3 class="panel-title"><i class="fa fa-2x fa-envelope-open" aria-hidden="true"></i> Create EMR Record</h3>
			...
			<div class="panel-body">
				...
				<form class="validateForm" action="{{ route('emr-records.store') }}" method="POST" enctype="multipart/form-data" role="form">
