...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset( 'public/lib/bootstrap/css/bootstrap.min.css') }}" />
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset( 'public/css/multipletab.css') }}" />
    <script src="{{ asset( 'public/js/tabber.js') }}" type="text/javascript"></script>
    <script src="{{ asset( 'public/js/tabber-minimized.js') }}" type="text/javascript"></script>
...
<body class="theme-blue">
    ...
    <div id="site-content" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="content" style="margin-left: 0;border-left: 0;">
