    ...
    <div class="col-sm-4 col-xs-12">
        ...
        <div class="panel panel-default panel-custom">
        	...
        	<div class="panel-heading">
        		<div class="row">
					<div class="col-sm-12 col-xs-12">
						<h3 class="panel-title"><i class="fa fa-2x fa-book"></i> Create Document Library <a style="position: absolute;top: 5px;right: 15px;" href="{{ route('document-library.index') }}" class="btn btn-custom-danger btn-xs pull-right">&laquo; Back</a></h3>
					</div>
				</div>
        	</div>
            ...
            <div class="panel-body">
            	...
            	<form class="validateForm" action="{{ route('document-library.store') }}" method="POST" enctype="multipart/form-data" role="form">
					@csrf
					...
					<div class="form-group">
						...
						<select name="company_name" class="form-control validate[required]">
							<?php $company_name = old('company_name'); ?>
					...
					<input type="submit" name="upload" class="btn btn-custom-primary" value="Create" />
