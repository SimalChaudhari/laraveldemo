...
<!--[if lt IE 9]>
<script type="text/javascript" src="{{ asset('public/lib/jSignature/flashcanvas.js') }}path/to/"></script>
<![endif]-->
	...
	<div class="col-sm-8 col-xs-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="validateForm" id="business_associate_agreement_form" method="POST" action="{{ route('business-associate-agreement.update', $form->uuid) }}" role="form">
					
					@csrf

					<p>This Business Associate Agreement is made a part of the contract ("Contract") by and between <input type="text" name="covered_entity" class="validate[required, maxSize[255]]" value="{{ $form->covered_entity }}" /> the Covered Entity ("CE") and <input type="text" name="business_associate" class="validate[required, maxSize[255]]" value="{{ $form->business_associate }}" /> the Business Associate ("BA"), Dated <input type="text" class="datepicker validate[required, custom[date]]" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" name="agreement_dated_on" autocomplete="off" value="{{ \Carbon\Carbon::parse( $form->agreement_dated_on )->format( config('app.VIEW_DATE_FORMAT') ) }}" />.</p>

					<p>This Agreement is effective as of <input type="text" class="datepicker validate[required, custom[date]]" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" name="effective_date" autocomplete="off" value="{{ \Carbon\Carbon::parse( $form->effective_date )->format( config('app.VIEW_DATE_FORMAT') ) }}" /> (the "Agreement Effective Date").</p>
					...
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							...
							<p><input type="text" name="covered_entity_name_footer" class="validate[required, maxSize[255]]" value="{{ $form->covered_entity_name_footer }}" /></p>
							...
							<div class="form-group">
								...
								<input type="hidden" name="covered_entity_signature_base" id="covered_entity_signature_base" value="{{ $form->covered_entity_signature_base }}" />
								<input type="hidden" name="covered_entity_signature_svg" id="covered_entity_signature_svg" value="{{ $form->covered_entity_signature_svg }}" />
							</div>

							<div class="clearfix"></div>
							<p>&nbsp;</p>
							<p><strong>Print Name:</strong> <input type="text" name="coverted_entity_print_name" class="validate[required, maxSize[255]]" value="{{ $form->coverted_entity_print_name }}" /></p>
							<p><strong>Title:</strong> <input type="text" name="covered_entity_title" class="validate[required, maxSize[255]]" value="{{ $form->covered_entity_title }}" /></p>
							<p><strong>Date:</strong> <input type="text" name="covered_entity_date" class="datepicker validate[required, custom[date]]" value="{{ \Carbon\Carbon::parse( $form->covered_entity_date )->format( config('app.VIEW_DATE_FORMAT') ) }}" /></p>
						</div>

						<div class="col-sm-12 col-xs-12">
							<h4>BUSINESS ASSOCIATE</h4>
							
							<p><input type="text" name="business_associate_name_footer" class="validate[required, maxSize[255]]" value="{{ $form->business_associate_name_footer }}" /></p>
							...
							<div class="form-group">
								...
								<input type="hidden" name="business_associate_signature_base" id="business_associate_signature_base" value="{{ $form->business_associate_signature_base }}" />
								<input type="hidden" name="business_associate_signature_svg" id="business_associate_signature_svg" value="{{ $form->business_associate_signature_svg }}" />
							</div>

							<div class="clearfix"></div>
							<p>&nbsp;</p>

							<p><strong>Print Name:</strong> <input type="text" name="business_associate_print_name" class="validate[required, maxSize[255]]" value="{{ $form->business_associate_print_name }}" /></p>
							<p><strong>Title:</strong> <input type="text" name="business_associate_title" class="validate[required, maxSize[255]]" value="{{ $form->business_associate_title }}" /></p>
							<p><strong>Date:</strong> <input type="text" name="business_associate_date" class="datepicker validate[required, custom[date]]" value="{{ \Carbon\Carbon::parse( $form->business_associate_date )->format( config('app.VIEW_DATE_FORMAT') ) }}" /></p>
						</div>
					</div>
