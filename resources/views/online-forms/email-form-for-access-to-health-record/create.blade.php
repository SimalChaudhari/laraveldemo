...
@section('page_title')
Create: {{ ucwords( strtolower( 'EMAIL FORM FOR ACCESS TO HEALTH RECORD' ) ) }}
@endsection
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="emailFormForAccessToHealthRecordForm" class="validateForm" method="POST" action="{{ route('saveEmailFormForAccessToHealthRecord') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="f_name" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="l_name" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="address1" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="address2" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="city" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="state" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="zip" class="form-control validate[required, maxSize[6]]" />
                        ...
                        <div class="col-sm-12 col-xs-12"> 
                            ...
                            <p>Dear Ms. Doe:</p>
                            <p style="text-align:justify;">This letter responds to your request for access to your health information, which we received from you on <input type="text" name="req_name" class="datepicker validate[required, custom[date]]" />. We have determined that the following fees will apply if weprocess your request:</p>
                            <ul style="list-style-type: none;">
                                <li>A fee of $<input type="text" name="summary_charge" class="validate[required]" size="10"/> will be charged to prepare a summary of the information for you.</li>
                                </br>
                                <li>A fee of $<input type="text" name="explanation_charge" class="validate[required]" size="10"/> will be charged to prepare an explanation of the information for you.</li>
                                </br>
                                <li>A fee of $<input type="text" name="expedited_charge" class="validate[required]" size="10" /> will be charged for expedited request.</li>
                            </ul>
                            ...
                            <p>Sincerely,</p>
                            <input type="text" name="app_name" class=" validate[required, maxSize[255]]" />
                        </div>
