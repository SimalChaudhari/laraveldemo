...
@section('page_title')
Create: {{ ucwords( strtolower( 'EMAIL FORM FOR HEALTH RECORD AMMENDMENT' ) ) }}
@endsection
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="emailFormForHealthRecordAmmendment" class="validateForm" method="POST" action="{{ route('saveEmailFormForHealthRecordAmmendment') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="zip" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-12">
                            ...
                            <p style="text-align:justify;">This letter responds to your request that we amend your health information, which we received
                                from you on <input type="text" name="last_date" class="datepicker validate[required, custom[date]]" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" autocomplete="off" />. We agree to make the amendment that you have requested. Your records will be updated accordingly.
                            </p>
