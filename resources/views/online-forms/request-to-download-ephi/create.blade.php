...
@section('page_title')
Create: {{ ucwords( strtolower( 'Request to Download/Copy' ) ) }} EPHI
@endsection
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="requestToDownloadEphiForm" class="validateForm" method="POST" action="{{ route('saveRequestToDownloadEPHI') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="person" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <textarea name="purpose" class="form-control validate[required]"></textarea>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="approve" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Date</label>
                                <div class="input-group">
                                    <input type="text" name="app_date" class="form-control datepicker validate[required, custom[date]]" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" autocomplete="off" />
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                    @error('app_date')
                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="not_approve" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="buss" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="sub" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="agree" value="Yes" /> Business Associate Agreement In-Place with Business Associate
                                </label>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>
                                    <input type="checkbox" name="sub_cont" value="Yes" /> Sub-Contractor states They Have an omnibus BAA with the B.A.
                                </label>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="port" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 no-padding">
                                    <label>
                                        <input type="checkbox" name="device" value="Yes" /> Business Associate stated Device is New or scanned for Malware
                                    </label>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="encry" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 col-xs-12 no-padding">
                                    <label>
                                        <input type="checkbox" name="encry_veri" value="Yes" /> Encryption Verified
                                    </label>
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="records" class="form-control validate[required, maxSize[255]]" />
