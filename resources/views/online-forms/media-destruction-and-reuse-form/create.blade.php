...
@section('page_title')
Create: {{ ucwords( strtolower( 'MEDIA DESTRUCTION AND/OR REUSE FORM' ) ) }}
@endsection
    ...
    <div class="col-sm-8 col-xs-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form name="mediaDestructionAndReuseForm" class="validateForm" method="POST" action="{{ route('saveMediaDestructionAndReuseForm') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="device" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="media" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="loca" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="item_desc" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="model" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="serial" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="asset" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="backup_loc" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label>Item Description{!! $required_field_html !!}</label>
                                <input type="text" name="descri" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="con_date" class="form-control datepicker validate[required, custom[date]]" placeholder="{{ config('app.DATE_FORMAT_PLACEHOLDER') }}" autocomplete="off" />
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="cond" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vali" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="vali_phone" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="sani" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="notes" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="prof" class="form-control validate[required, maxSize[255]]" />
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="officer" class="form-control validate[required, maxSize[255]]" />
