    ...
    <div class="col-sm-4 col-xs-12">
        ...
        <div class="panel panel-default panel-custom">
        	...
        	<div class="panel-heading">
        		<div class="row">
					<div class="col-sm-12 col-xs-12">
						<h3 class="panel-title"><i class="fa fa-2x fa-file" aria-hidden="true"></i> Add Report</h3>
					</div>
				</div>
        	</div>
            ...
            <div class="panel-body">
            	...
            	<form action="{{ route('technology-report.store') }}" method="POST" enctype="multipart/form-data" role="form">
					...
					<input type="submit" name="submit" class="btn btn-primary" value="Add Report" />
