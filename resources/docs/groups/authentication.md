...
curl -X POST \
    ...
    -d '{"username":"admin","password":"recusandae"}'
...
<input type="text" name="username" data-endpoint="POSTapi-auth-login" data-component="body" required  hidden>
<br>
...
<form id="form-GETapi-auth-user-profile" data-method="GET" data-path="api/auth/user-profile" data-authed="1" data-hasfiles="0" data-headers='{"Authorization":"Bearer {YOUR_AUTH_KEY}","Content-Type":"application\/json","Accept":"application\/json"}' onsubmit="event.preventDefault(); executeTryOut('GETapi-auth-user-profile', this);">
<h3>
    Request&nbsp;&nbsp;&nbsp;
...
<p>
<label id="auth-GETapi-auth-user-profile" hidden>Authorization header: <b><code>Bearer </code></b><input type="text" name="Authorization" data-prefix="Bearer " data-endpoint="GETapi-auth-user-profile" data-component="header"></label>
</p>
</form>
